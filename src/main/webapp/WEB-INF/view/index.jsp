...
<section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
        ...
        <a href="https://www.youtube.com/watch?v=hd4ZWBNCg8w" class="glightbox play-btn mb-4"></a>
...
<main id="main">
    ...
    <section id="speakers">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <c:forEach items="${homePage.content}" var="x">
                    <div class="col-lg-4 col-md-6">
                        <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                            <c:choose>
                                <c:when test="${x.getListCtsp().get(0).getListHinh().size() != 0}">
                                    <!-- Thực thi dòng code nếu giá trị không null -->

                                    <img src="..${x.getListCtsp().get(0).getListHinh().get(0).getUrl()}" alt="Speaker 1"
                                         class="img-fluid"
                                         style="width: 416px; height: 416px ; object-fit: cover ">
                                </c:when>
                                <c:otherwise>
                                    <!-- Thực thi dòng code khác nếu giá trị là null -->
                                    <img src="./assets/img/speakers/default.jpg" alt="Speaker 2" class="img-fluid">
                                </c:otherwise>
                            </c:choose>

                            <div class="details">
                                <h3><a href="/home/product/detail?id=${x.getId()}">${x.getTen()}</a></h3>
                                <p style="color: #fc6b6b">${x.getListCtsp().get(0).getGiaBan()} $</p>
                                <p>${x.getListCtsp().get(0).getMota()}</p>

                                <div class="social">
                                    <a href="" class="btn btn-dark"><i class="fa-solid fa-cart-shopping"></i> Add to
                                        cart</a>
                                    <a href="" class="btn btn-dark"><i class="fa-solid fa-dollar-sign"></i>Buy now</a>
            ...
            <div>
                <span> Total Items: ${totalItems} - Page ${currentPage+1} of ${totalPages}</span>
                &nbsp;
                <c:forEach var="i" begin="1" end="${totalPages}">
        <span>
                <a href="/home?curent_page=${i-1}">${i}</a>
        </span> &nbsp;&nbsp;
                </c:forEach>

                <c:choose>
                    <c:when test="${currentPage < totalPages-1}">
                        <a href="/home?curent_page=${currentPage + 1}" class="btn btn-dark">Next</a>
                    </c:when>
                    <c:otherwise>
                        <span>Next</span>
                    </c:otherwise>
                ...
                <c:choose>
                    <c:when test="${currentPage > 0}">
                        <a href="/home?curent_page=${currentPage - 1}" class="btn btn-dark">Previous</a>
                    </c:when>
                    <c:otherwise>
                        <span>Previous</span>
                    </c:otherwise>
                    ...
                    <div class="card mb-5 mb-lg-0">
                        <div class="card-body">
                            ...
                            <ul class="fa-ul">
                                ...
                                <li class="text-muted"><span class="fa-li"><i class="fa fa-times"></i></span>Community
                                    Access
                                </li>
                                <li class="text-muted"><span class="fa-li"><i class="fa fa-times"></i></span>Workshop
                                    Access
                                </li>
                                <li class="text-muted"><span class="fa-li"><i class="fa fa-times"></i></span>After Party
                                </li>
                            </ul>
                            <hr>
                            <div class="text-center">
                                <button type="button" class="btn" data-bs-toggle="modal"
                                        data-bs-target="#buy-ticket-modal" data-ticket-type="standard-access">Buy Now
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card mb-5 mb-lg-0">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <button type="button" class="btn" data-bs-toggle="modal"
                                        data-bs-target="#buy-ticket-modal" data-ticket-type="pro-access">Buy Now
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <button type="button" class="btn" data-bs-toggle="modal"
                                        data-bs-target="#buy-ticket-modal" data-ticket-type="premium-access">Buy Now
                                </button>
                            </div>
