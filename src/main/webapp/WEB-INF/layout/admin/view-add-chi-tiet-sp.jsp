...
<div class="container-fluid">
    ...
    <form:form action="/admin/productDetail/add" method="post" modelAttribute="chiTietSp" enctype="multipart/form-data">
            ...
            <div style="margin: 0 40px">
                ...
                <form:select path="sanPham"
                    ...
                    <c:forEach items="${listSanPham}" var="sp">
                        <form:option value="${sp}" cssStyle="line-height: 30px"> ${sp.ma} - ${sp.ten}</form:option>
                    </c:forEach>
                </form:select>
                <br>
                <br>
